  ...
  <view>
    ...
    <view class="content">
      <view class="content_1">
        <view class="content_1_1">{{ tipData }}</view>
      </view>
    </view>
  </view>
</template>
...
export default {
  data() {
    return {
      tipData: `提示条款
在使用【火客云创】各项产品或服务前，请您务必仔细阅读并透彻理解本政策，特别是以粗体/粗体下划线标识的条款，您应重点阅读，在确认充分理解并同意后再开始使用。如对本政策内容有任何疑问、意见或建议，您可通过【火客云创】提供的各种联系方式与我们联系。

您的信任对我们非常重要，我们深知个人信息对您的重要性，我们将按法律法规要求，采取相应安全保护措施，尽力保护您的个人信息安全可控。鉴于此，【火客云创】服务提供者（或简称“我们”或“【火客云创】”）制定本《隐私政策》（下称“本政策 /本隐私政策”）并提醒您：本政策适用于【火客云创】提供的所有产品和服务及我们的关联公司的产品或服务（如【火客云创】小程序），您可使用【火客云创】平台帐号登录上述产品或服务，如上述产品或服务未设独立隐私政策的，则本政策同样适用于该部分产品或服务。

需要特别说明的是，本政策不适用于其他第三方向您提供的服务，也不适用于【火客云创】中已另行独立设置隐私政策的产品或服务。

第一部分 定义
【火客云创】服务提供者：【徐州星跃联动网络科技有限公司】
...
除另有约定外，本政策所用定义与【火客云创】平台用户协议中的定义具有相同的涵义。
...
2、为给您带来更好的产品和服务体验，我们在持续努力改进我们的技术，随之我们可能会不时推出新的或优化后的功能，可能需要重新收集、使用您的个人信息或变更个人信息使用目的或方式。对此，我们将通过更新本政策、弹窗、页面提示方式另行向您说明对应信息的收集目的、范围及使用方式，并征求您的明示同意。在此过程中，如果您有任何疑问、意见或建议的，您可通过【火客云创】提供的各种联系方式与我们联系，我们会尽快为您作出解答。
...
注册成为会员并使用我们的会员服务，您需要提供手机号码、拟使用的会员名和密码用于创建【火客云创】平台账户。如果您仅需使用浏览、搜索服务，您不需要注册成为我们的会员及提供上述信息。
...
授权登录：经您同意后我们向第三方共享您的账户信息（如微信，我们可能会共享您的头像、昵称），使您可以便捷地以【火客云创】平台帐户实现第三方平台的注册或登录。此外，我们可能会根据您的授权从第三方处获取您的第三方账户信息，并与您的【火客云创】平台账户进行绑定，使您可通过第三方账户直接登录、使用我们的产品及/或服务。我们将在您授权同意的范围内使用您的相关信息。

提现功能：经您同意后，我们将取得您的真实姓名、手机号码信息，与您已有的支付宝帐号进行实名匹配验证；验证通过后，您可以将【火客云创】中的费用提现至您的支付宝中。
...
3、账户信息展示：如果您已拥有【火客云创】平台账户，我们可能会在【火客云创】平台服务中显示您的上述个人信息（实人认证仅显示认证是否通过的结果），以及您在【火客云创】平台上或与【火客云创】平台账户相关联的产品和服务中执行的操作（您可通过【火客云创】平台账户在我们提供的手机【火客云创】入口或其他产品/服务入口使用我们及/或关联公司提供的产品或服务），包括通过【火客云创】平台账户集中展示您的个人资料、优惠权益、交易订单。我们会尊重您对【火客云创】平台服务和【火客云创】平台账户设置所做的选择。
...
您可以通过【火客云创】为其他人订购商品及/或服务，您需要提供该实际订购人的前述个人信息，若其中涉及儿童个人信息的，您需在提供前征得对应儿童监护人的同意。
...
为完成订单支付，您需要提供支付账户并选择付款方式，我们会将您的【火客云创】平台账户会员名、对应的支付账户会员名、订单支付相关信息及其他反洗钱法律要求的必要信息与第三方支付公司共享。如您选择由其他金融机构为您提供支付服务的，我们或我们的关联公司、合作伙伴还会将您的包括银行卡号、有效期在内的银行卡支付必要信息与您选择的相应金融机构共享。
...
为保证您购买的商品及/或服务能够顺利、安全、准确送达，我们会向为【火客云创】平台提供物流信息系统和技术服务的物流配送公司披露订单相关配送信息，并由其根据商品及/或服务提供主体的指定向相应的物流配送主体同步相关配送信息。您知晓并同意相应物流配送主体不可避免地获知及使用您的配送信息，用于完成交付目的。
...
为提高您使用我们及我们关联公司、合作伙伴提供服务的安全性，保护您或其他用户或公众的人身财产安全免遭侵害，更好地预防钓鱼网站、欺诈、网络漏洞、计算机病毒、网络攻击、网络侵入安全风险，更准确地识别违反法律法规或【火客云创】相关协议规则的情况，我们可能使用或整合您的会员信息、交易信息、设备信息、服务日志信息以及我们关联公司、合作伙伴取得您授权或依据法律共享的信息，来综合判断您账户及交易风险、进行身份验证、检测及防范安全事件，并依法采取必要的记录、审计、分析、处置措施。

（九）为您提供其他附加服务

为向您提供更便捷、更优质、个性化的产品及/或服务，努力提升您的体验，我们在向您提供的以下附加服务中可能会收集、缓存和使用您的个人信息。如果您不提供这些信息，不会影响您使用【火客云创】的浏览、搜索基本服务，但您可能无法获得这些附加服务给您带来的用户体验。这些附加服务包括：
...
5、基于检索正在运行应用的附加功能：此功能可以使您在浏览【火客云创】商品、服务时跳转到第三方APP的指定页面。

6、基于相册（图片库/视频库）的图片/视频访问及上传、外部存储、缓存、发布音视频功能的附加服务：您可在开启相册权限后使用该功能上传您的照片/图片/视频，发表评论/分享、拍照购物或与客服沟通提供证明等功能。我们可能会通过您所上传的照片/图片来识别您需要购买的商品或服务，或使用包含您所上传照片或图片的评论信息。您如果拒绝授权提供，将无法使用此功能，但不影响您正常使用【火客云创】的其他功能。
...
1、若你提供的信息中含有其他用户的个人信息，在向【火客云创】提供这些个人信息之前，您需确保您已经取得合法的授权。若其中涉及儿童个人信息的，您需在发布前取得对应儿童监护人的同意，前述情形下监护人有权通过本政策第十条的途径联系我们，要求更正或删除涉及儿童个人信息的内容。
...
请知悉，根据适用的法律，若我们对个人信息采取技术措施和其他必要措施进行处理，使得数据接收方无法重新识别特定个人且不能复原，或我们可能会对收集的信息进行去标识化地研究、统计分析和预测，用于改善【火客云创】的内容和布局，为商业决策提供产品或服务支撑，以及改进我们的产品和服务（包括使用匿名数据进行机器学习或模型算法训练），则此类处理后数据的使用无需另行向您通知并征得您的同意。

4、如我们停止运营【火客云创】产品或服务，我们将及时停止继续收集您个人信息的活动，将停止运营的通知以逐一送达或公告的形式通知您，并对我们所持有的与已关停业务相关的个人信息进行删除或匿名化处理。涉及儿童个人信息的，我们会并将停止运营的通知及时告知儿童监护人。
...
若您不同意我们在您的移动设备上存储Cookie的小数据文件，您可停止使用【火客云创】。

三、我们如何共享、转让、公开披露您的信息
（一）共享

我们不会与【火客云创】服务提供者以外的公司、组织和个人共享您的个人信息，但以下情况除外：

1、在法定情形下的共享：我们可能会根据法律法规规定、诉讼、争议解决需要，或按行政、司法机关依法提出的要求，对外共享您的个人信息。

2、在获取明确同意的情况下共享：获得您的明确同意后，我们会与其他方共享您的个人信息。

3、在您主动选择情况下共享：您通过【火客云创】平台购买商品或服务，我们会根据您的选择，将您的订单信息中与交易有关的必要信息共享给相关商品或服务的提供者，以实现您的交易及售后服务需求。

4、与关联公司间共享：为便于我们基于【火客云创】平台账户向您提供产品和服务，推荐您可能感兴趣的信息，识别会员账号异常，保护【火客云创】关联公司或其他用户或公众的人身财产安全免遭侵害，您的个人信息可能会与我们的关联公司和/或其指定的服务提供商共享。我们只会共享必要的个人信息，且受本隐私政策中所声明目的的约束，如果我们共享您的个人敏感信息或关联公司改变个人信息的使用及处理目的，将再次征求您的授权同意。
